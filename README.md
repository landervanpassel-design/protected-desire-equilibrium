> **Exploratory origins of the reconstruction framework.** This repository holds the earliest,
> conceptual multi-agent simulation work on the protected-floor idea (D ≥ D_min). The rigorous
> mathematics grew out of it: the **[Reconstruction Theorem](https://github.com/landervanpassel-design/reconstruction-theorem)**
> (Distortion Field, certified recovery bounds), demonstrated in practice by
> **[CDI on the IEEE 9-bus grid](https://github.com/landervanpassel-design/grid-resilience-demo)**.
> Framework overview: [desire-gravity-lineage](https://github.com/landervanpassel-design/desire-gravity-lineage).
